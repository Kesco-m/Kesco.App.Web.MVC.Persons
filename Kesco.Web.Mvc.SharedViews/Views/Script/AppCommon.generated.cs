...
"vable(false),\r\n\t\tScriptStartTime: new Date(),\r\n\r\n\t\tEmployeePhones: ko.observable" +
"Array([]),\r\n\t\tEmployeePhonesLoading: ko.observable(false),\r\n\t\tCallStation: {\r\n\t\t" +
"\tMode: ko.observable(0),\r\n\t\t\tMessage: ko.observable(\'\'),\r\n\t\t\tPhone: ko.observabl" +
"e($.cookie(\"ep\")),\r\n\t\t\tPhoneInfo: ko.observable({}),\r\n\t\t\tPhoneLocation: ko.obser" +
"vable(),\r\n\t\t\tTargetPhone: ko.observable(\'\'),\r\n\t\t\tTargetPhoneDisplay: ko.observab" +
"le(\'\'),\r\n\t\t\tCalling: ko.observable(false),\r\n\t\t\tCallInfo: null,\r\n\t\t\tMonitorID: ko" +
".observable(),\r\n\t\t\tSaveSettings: ko.observable($.cookie(\"eps\")),\r\n\t\t\tCallEstabli" +
"shing: ko.observable(false)\r\n\t\t},\r\n\t\tDefaultEmployeePhone: ko.observable($.cooki" +
"e(\"ep\")),\r\n\r\n\r\n\t\tcloseDialog: function () { \r\n\t\t\tvar opener = window.opener || w" +
"indow.parent;\r\n\t\t\tif (opener && !opener.closed) {\r\n\t\t\t\topener.blur();\r\n\t\t\t\topene" +
"r.focus();\r\n\t\t\t} \r\n\t\t\twindow.self.close();\r\n\t\t},\r\n\t\trefreshPage: function () { \r" +
"\n\t\t\tViewModel.Processing(true);\r\n\t\t\tif (window.top != window.self) {\r\n\t\t\t\t// Пер" +
"егрузим IFRAME\r\n\t\t\t\twindow.parent.document.getElementById(window.self.name).src " +
"= window.self.location + \"&t=1\";\r\n\t\t\t} else {\r\n\t\t\t\twindow.location.reload();\r\n\t\t" +
"\t}\r\n\t\t\tViewModel.Processing(false);\r\n\t\t},\r\n\r\n\t\tshowUser: function (id) {\r\n\t\t\tope" +
"nPopupWindow(Env.URI_user_form+\'?id=\'+id, null, null, \"wnd_ViewUser_\"+id, 800, 6" +
"00, { close: false, centerScreen:0 });\r\n\t\t},\r\n\r\n\t\tshowPerson: function (id) {\r\n\t" +
"\t\topenPopupWindow(Env.URI_person_form+\'?id=\'+id, null, null, \"wnd_ViewPerson_\"+i" +
"d, 800, 600, { close: false, centerScreen:0 });\r\n\t\t},\r\n\r\n\t\tshowResource: functio" +
"n (id) {\r\n\t\t\topenPopupWindow(Env.URI_resource_form+\'?id=\'+id, null, null, \"wnd_S" +
"howResource_\"+id, 800, 600, { close: false, centerScreen:0 });\r\n        },\r\n\r\n  " +
...
"\r\n\t\t\t}\r\n\t\t\tKesco.windowOpen(\'mailto:\'+email);\r\n\t\t},\r\n\r\n\t\topenMessengerChat: func" +
"tion (contact)\r\n\t\t{\r\n\t\t\ttry {\r\n\t\t\t\tvar obj = new ActiveXObject(\"Messenger.Messen" +
"gerApp\");\r\n\t\t\t\tif(obj) obj.LaunchIMUI(contact);\r\n\t\t\t} catch (e) {\r\n\t\t\t\tpostClien" +
"tError(e.message, \'\', \'openMessengerChat\');\r\n\t\t\t}\r\n\t\t},\r\n\r\n\t\tshowPersonInfo: fun" +
"ction(personID, title, $target, positionMy, positionAt, showEvent, createSpan, o" +
"ptions) {\r\n\t\t\tif (!personID) return;\r\n\t\t\tvar url = Env.URI_person_info;\r\n\t\t\turl " +
"= url.replace(\"/0\", \"/\"+personID);\r\n\t\t\tthis.showTip(url, title, $target, positio" +
"nMy, positionAt, showEvent, createSpan, options);\r\n\t\t},\r\n\r\n\t\tshowEmployeeInfo: f" +
"unction(employeeID, title, $target, positionMy, positionAt, showEvent, createSpa" +
"n, options) {\r\n\t\t\tif (!employeeID) return;\r\n\t\t\tvar url = Env.URI_user_info;\r\n\t\t\t" +
"url = url.replace(\"/0\", \"/\"+employeeID);\r\n\t\t\tthis.showTip(url, title, $target, p" +
"ositionMy, positionAt, showEvent, createSpan, options);\r\n\t\t},\r\n\r\n\t\tshowTip: func" +
"tion(url, title, $target, positionMy, positionAt, showEvent, createSpan, options" +
") {\r\n\t\t\tif (!$target.data(\"qtip\")) {\r\n\t\t\t\tthis.createTip($target, url, title, po" +
"sitionMy, positionAt, showEvent, createSpan, options);\r\n\t\t\t\t$target.qtip(\"show\")" +
";\r\n\t\t\t\t$(\"#ui-tooltip-\"+$target.qtip(\"api\").get(\'id\')).resizable({\r\n\t\t\t\t\tanimate" +
"2: true, animateDuration2: \"fast\",\r\n\t\t\t\t\tminWidth: 320, minHeight: 160,\r\n\t\t\t\t\tst" +
"art: function() {\r\n\t\t\t\t\t\t$target.qtip(\"api\").set({ \'hide.event\': false});\r\n\t\t\t\t\t" +
"},\r\n\t\t\t\t\tend: function() {\r\n\t\t\t\t\t\t$target.qtip(\"api\").set({ \'hide.event\': \'mouse" +
"leave\'});\r\n\t\t\t\t\t}\r\n\t\t\t\t});\r\n\t\t\t} else {\r\n\t\t\t\tif (showEvent) return;\r\n\t\t\t\t$target" +
"\r\n\t\t\t\t\t.qtip(\"option\",\"content.ajax.url\", url)\r\n\t\t\t\t\t.qtip(\"toggle\");\r\n\t\t\t}\r\n\t\t}" +
",\r\n\r\n\t\tcreateTip: function($target, url, title, positionMy, positionAt, showEven" +
"t, createSpan, options) {\r\n\t\t\tcreateSpan = !! createSpan;\r\n\t\t\tif ($target.data(\"" +
"qtip\")) return;\r\n\t\t\tvar $span = false;\r\n\t\t\tif (createSpan) {\r\n\t\t\t\t$span = $(\"<sp" +
"an");
...
"rd: function (text) {\r\n\t        text = text.substring(text.indexOf(\"(\", 0), text" +
".length);\r\n\t        text = text.replace(RegExp(\'[^0-9]{1,}\', \'ig\'), \'\');\r\n\t     " +
"   //alert(text);\r\n\t        window.clipboardData.setData(\"Text\", text);\r\n\t    }," +
"\r\n        \r\n        FromJS: function (from, to) {\r\n            var data = to || " +
"{};\r\n            return ko.mapping.fromJS(from, {}, data);\r\n        },\r\n\r\n      " +
"  ToJS: function (from, to) {\r\n            var data = to || {};\r\n            dat" +
"a = ko.mapping.toJS(from);\r\n            return data;\r\n        },\r\n\r\n        ToJS" +
"ON: function (from, to) {\r\n            var data = to || {};\r\n            data = " +
"ko.mapping.toJSON(from);\r\n            return data;\r\n        },\r\n\r\n        closeP" +
"honeDialog: function()\r\n        {\r\n            $(\"#PhoneCalling_Dialog\").dialog(" +
"\"close\");\r\n        },\r\n\r\n        makeCall: function (contact, intlPhoneNumber, c" +
"id, ctype, icon)\r\n\t\t{            \r\n\t\t\tvar self = this;\r\n\t\t\tif (!intlPhoneNumber)" +
...
"amsURI += \"&number=\" + contact;\r\n                    _paramsURI += \"&internumber" +
"=\" + intlPhoneNumber.replace(\" \", \"\");\r\n                    _paramsURI += \"&comp" +
"uterName=\" + ViewModel.ClientName;\r\n\r\n                Kesco.makeCall(Env.URI_pho" +
"nes, Env.URI_contacts_caller, _paramsURI, contact);               \r\n\t\t\t}\r\n\r\n    " +
"        var isCall = false;\r\n\t\t\tif (self.ClientName || (ViewModel.ClientName != " +
...
"                        isCall = true;\r\n                                doMakeCa" +
"ll();\r\n                            }\r\n            },1000);\r\n            \r\n\t\t\tret" +
"urn;\r\n\t\t}\r\n\r\n\t};\r\n\r\n\t// Расширить глобальную модель\r\n\twindow.ViewModel = $.exten" +
"d(window.ViewModel || {}, ViewModel);\r\n\r\n\r\n\t");
...
"rn xhr; \r\n\r\n\t}\r\n\r\n\tfunction makeCall() {        \r\n\t\tvar phone = ViewModel.CallSt" +
"ation.Phone().split(\"/\");\r\n\t\tvar xhr = $.ajax({\r\n\t\t\t\ttimeout: 15000,\r\n\t\t\t\turl: E" +
"nv.URI_Default_MakeCall,\r\n\t\t\t\ttype: \'POST\',\r\n\t\t\t\tdata: {\r\n\t\t\t\t\tclientName: ViewM" +
"odel.ClientName,\r\n\t\t\t\t\tphone: phone[0],\r\n\t\t\t\t\tequipmentID: phone[1],\r\n\t\t\t\t\ttarge" +
"tPhone: ViewModel.CallStation.TargetPhone()\r\n\t\t\t\t},\r\n\t\t\t\tbeforeSend: function() " +
"{\r\n\t\t\t\t\tViewModel.CallStation.Message(Env.Localization.PhoneCalling_Dialog_Phone" +
"CallState_Connecting);\r\n\t\t\t\t\tViewModel.CallStation.Calling(true);\r\n\t\t\t\t\tViewMode" +
"l.CallStation.CallInfo = null;\r\n\t\t\t\t\tViewModel.CallStation.CallEstablishing(true" +
");\r\n\t\t\t\t}\r\n\r\n\t\t\t})\r\n\t\t\t.success(function(response, status, xhr) { \r\n\t\t\t\tif (resp" +
"onse.status == \"ok\") {\r\n\t\t\t\t\tif (response.model.callInfo.CallID) {\r\n\t\t\t\t\t\tViewMo" +
"del.CallStation.Message(Env.Localization.PhoneCalling_Dialog_PhoneCallState_Call" +
");\r\n\t\t\t\t\t\tViewModel.CallStation.Calling(true);\r\n\t\t\t\t\t\tViewModel.CallStation.Call" +
"Info = response.model.callInfo;\r\n\t\t\t\t\t} else {\r\n\t\t\t\t\t\tViewModel.CallStation.Mess" +
"age(Env.Localization.MakeCall_CallCannotBeEstablished\r\n\t\t\t\t\t\t\t\t+((ViewModel.Empl" +
"oyeePhones().length > 1)?(\'<br><br>\'+Env.Localization.MakeCall_TryToCallFromAnot" +
"herPhone):\'\')\r\n\t\t\t\t\t\t\t);\r\n\t\t\t\t\t\tViewModel.CallStation.Calling(false);\r\n\t\t\t\t\t}\r\n\t" +
"\t\t\t}\r\n\t\t\t\tif (response.status == \"error\") {\r\n\t\t\t\t\tViewModel.CallStation.Message(" +
"response.error);\r\n\t\t\t\t\tViewModel.CallStation.Calling(false);\r\n\t\t\t\t\tViewModel.Cal" +
"lStation.CallInfo = null;\r\n\t\t\t\t}\r\n\t\t\t})\r\n\t\t\t.error(function(xhr, status, errorTh" +
"rown) { \r\n\t\t\t\tif (status != \"abort\") {\r\n\t\t\t\t\tViewModel.CallStation.Message($.val" +
"idator.format(Env.Localization.Ajax_Alert_Message_RequestError, status, errorThr" +
"own));\r\n\t\t\t\t\tViewModel.CallStation.Calling(false);\r\n\t\t\t\t\tViewModel.CallStation.C" +
...
"CallStation.CallEstablishing(false); \r\n\t\t\t});\r\n\t\treturn xhr;\r\n\t}\r\n\r\n\tfunction ch" +
"eckCall() {\r\n\t\tvar phone = ViewModel.CallStation.Phone().split(\"/\");\r\n\t\tvar xhr " +
"= $.ajax({\r\n\t\t\t\ttimeout: 15000,\r\n\t\t\t\turl: Env.URI_Default_CheckCall,\r\n\t\t\t\ttype: " +
"\'POST\',\r\n\t\t\t\tdata: {\r\n\t\t\t\t\tcallID: (ViewModel.CallStation.CallInfo)?ViewModel.Ca" +
"llStation.CallInfo.CallID:0,\r\n\t\t\t\t\tclientName: ViewModel.ClientName,\r\n\t\t\t\t\tphone" +
": phone[0],\r\n\t\t\t\t\tequipmentID: phone[1],\r\n\t\t\t\t\ttargetPhone: ViewModel.CallStatio" +
"n.TargetPhone()\r\n\t\t\t\t},\r\n\t\t\t\tbeforeSend: function() {\r\n\t\t\t\t}\r\n\r\n\t\t\t})\r\n\t\t\t.succe" +
"ss(function(response, status, xhr) { \r\n\t\t\t\tif (response.status == \"ok\") {\r\n\t\t\t\t\t" +
"if (ViewModel.CallStation.Calling()) {\r\n\t\t\t\t\t\tViewModel.CallStation.Message(resp" +
"onse.model.message);\r\n\t\t\t\t\t\tViewModel.CallStation.Calling(response.model.active)" +
";\r\n\t\t\t\t\t\tViewModel.CallStation.CallInfo = response.model.callInfo;\r\n\t\t\t\t\t}\r\n\t\t\t\t" +
"}\r\n\t\t\t\tif (response.status == \"error\") {\r\n\t\t\t\t\tViewModel.CallStation.Message(res" +
"ponse.error);\r\n\t\t\t\t\tViewModel.CallStation.Calling(false);\r\n\t\t\t\t}\r\n\t\t\t})\r\n\t\t\t.err" +
"or(function(xhr, status, errorThrown) { \r\n\t\t\t\tif (status != \"abort\") {\r\n\t\t\t\t\tVie" +
"wModel.CallStation.Message(Env.Localization.CheckCall_Error);\r\n\t\t\t\t\tViewModel.Ca" +
"llStation.Calling(false);\r\n\t\t\t\t\talertMessage(Env.Localization.Ajax_Alert_Title_A" +
"pplicationError\r\n\t\t\t\t\t\t, $.validator.format(Env.Localization.Ajax_Alert_Message_" +
"RequestError, status, errorThrown)\r\n\t\t\t\t\t\t, Env.Localization.GUI_Button_OK);\r\n\t\t" +
"\t\t}\r\n\t\t\t})\r\n\t\t\t.complete(function() {\r\n\t\t\t\tViewModel._garbage(new Date()); \r\n\t\t\t" +
"});\r\n\t\treturn xhr;\r\n\t}\r\n\r\n\tfunction cancelCall() {\r\n\t\tvar phone = ViewModel.Call" +
"Station.Phone().split(\"/\");\r\n\t\tif (!ViewModel.CallStation.CallInfo) {\r\n\t\t\treturn" +
";\r\n\t\t}\r\n\t\tvar xhr = $.ajax({\r\n\t\t\t\ttimeout: 15000,\r\n\t\t\t\turl: Env.URI_Default_Canc" +
"elCall,\r\n\t\t\t\ttype: \'POST\',\r\n\t\t\t\tdata: {\r\n\t\t\t\t\tcallID: (ViewModel.CallStation.Cal" +
"lInfo)?ViewModel.CallStation.CallInfo.CallID:0,\r\n\t\t\t\t\tclientName: ViewModel.Clie" +
"ntName,\r\n\t\t\t\t\tphone: phone[0],\r\n\t\t\t\t\tequipmentID: phone[1],\r\n\t\t\t\t\ttargetPhone: V" +
"iewModel.CallStation.TargetPhone()\r\n\t\t\t\t},\r\n\t\t\t\tbeforeSend: function() { }\r\n\r\n\t\t" +
"\t})\r\n\t\t\t.success(function(response, status, xhr) { \r\n\t\t\t\tif (response.status == " +
"\"ok\") {\r\n\t\t\t\t\tViewModel.CallStation.Message(response.model.message);\r\n\t\t\t\t\t//Vie" +
"wModel.CallStation.Calling(false);\r\n\t\t\t\t}\r\n\t\t\t\tif (response.status == \"error\") {" +
"\r\n\t\t\t\t\tViewModel.CallStation.Message(response.error);\r\n\t\t\t\t\tViewModel.CallStatio" +
"n.Calling(false);\r\n\t\t\t\t}\r\n\t\t\t})\r\n\t\t\t.error(function(xhr, status, errorThrown) { " +
"\r\n\t\t\t\tif (status != \"abort\") {\r\n\t\t\t\t\tViewModel.CallStation.Message(Env.Localizat" +
"ion.CheckCall_Error);\r\n\t\t\t\t\tViewModel.CallStation.Calling(false);\r\n\t\t\t\t\talertMes" +
"sage(Env.Localization.Ajax_Alert_Title_ApplicationError\r\n\t\t\t\t\t\t, $.validator.for" +
"mat(Env.Localization.Ajax_Alert_Message_RequestError, status, errorThrown)\r\n\t\t\t\t" +
"\t\t, Env.Localization.GUI_Button_OK);\r\n\t\t\t\t}\r\n\t\t\t})\r\n\t\t\t.complete(function() {\r\n\t" +
"\t\t\tViewModel._garbage(new Date()); \r\n\t\t\t});\r\n\t\treturn xhr;\r\n\t}\r\n\r\n\tfunction abor" +
"tPhoneDialogTask() {\r\n\t\tif ($phoneDialogTask && $phoneDialogTask.state() == \"pen" +
"ding\") {\r\n\t\t\tif ($phoneDialogTask.abort) $phoneDialogTask.abort();\r\n\t\t\telse $pho" +
"neDialogTask.reject();\r\n\t\t}\r\n\t}\r\n\r\n\tvar $phoneDialogTask = null;\r\n\tvar $phoneDia" +
"logButtons = null;\r\n\tvar $phoneDialog_BeforeOpenActiveElement = null;\r\n\tvar $pho" +
"neDialog = $(\"#PhoneCalling_Dialog\").dialog({\r\n\t\tautoOpen: false, \r\n\t\twidth: $.c" +
"ookie(\"epw\") || 550, \r\n\t\theight: $.cookie(\"eph\") || 230, \r\n\t\tcloseOnEscape: fals" +
"e,\r\n\t\tminHeight: 200, minWidth: 350, modal: true, dialogClass: \'ui-dialog-titleh" +
"idden\',\r\n\t\tresizeStop: function(ev, ui) {\r\n\t\t\t$.cookie(\"epw\", Math.floor($phoneD" +
"ialog.dialog(\"option\", \"width\")), { expires: 365 });\r\n\t\t\t$.cookie(\"eph\", Math.fl" +
"oor($phoneDialog.dialog(\"option\", \"height\")), { expires: 365 });\r\n\r\n\t\t},\r\n\t\tcrea" +
"te: function(ev, ui) {\r\n\t\t\tvar $widget = $($(this).dialog(\"widget\"));\r\n\t\t\t$widge" +
"t.find(\'.ui-dialog-buttonpane\')\r\n\t\t\t\t.prepend(\"<div");
...
WriteLiteral(">");
            ...
            #line 705 "..\..\Views\Script\AppCommon.cshtml"
...
"var attempts = 0;\r\n\t\tvar attemptsLimit = 0;\r\n\t\tif (!ViewModel.CallStation.Callin" +
"g()) {\r\n\t\t\t// Если не удалось позвонить и телефон один, отмена\r\n\t\t\tif (ViewModel" +
".EmployeePhones().length == 1) {\r\n\t\t\t\tsetTimeout(function() { $($phoneDialogButt" +
"ons.get(2)).click(); }, 2000);\r\n\t\t\t} else {\r\n\t\t\t\tif ($.isFunction($phoneDialog.d" +
"ata(\"OnCallEndHandler\"))) \r\n\t\t\t\t\t$phoneDialog.data(\"OnCallEndHandler\").apply(thi" +
"s);\r\n\t\t\t}\r\n\t\t\treturn;\r\n\t\t}\r\n\r\n\t\tfunction timeoutExceeded() {\r\n\t\t\tViewModel.CallS" +
"tation.Calling(false);\r\n\t\t\tvar callInfo = ViewModel.CallStation.CallInfo;\r\n\t\t\tVi" +
"ewModel.CallStation.CallInfo = null;\r\n\t\t\tpostClientError(\r\n\t\t\t\t[\r\n\t\t\t\t\tEnv.Local" +
"ization.CheckCall_Error_CallCancellationFailed,\r\n\t\t\t\t\t\' [\',\r\n\t\t\t\t\tcallInfo.Calli" +
"ngPhone, \' --> \',\r\n\t\t\t\t\tcallInfo.CalledPhone, \' ConnectionState: \',\r\n\t\t\t\t\tcallIn" +
"fo.ConnectionState, \']\',\r\n\t\t\t\t].join(\"\"),\r\n\t\t\t\t\'Kesco.Zvonilka\',\r\n\t\t\t\t\'CheckCall" +
"\'\r\n\t\t\t);\r\n\t\t\t$phoneDialog.dialog(\"close\");\r\n\t\t}\r\n\r\n\t\tfunction intervalCheck() {\r" +
...
"sLimit = $phoneDialog.data(\"AttemptsLimit\") || 0;\r\n\t\t\tif (attemptsLimit && attem" +
"pts >= attemptsLimit) {\r\n\t\t\t\ttimeoutExceeded();\r\n\t\t\t\treturn;\r\n\t\t\t}\r\n\t\t\t$.when(co" +
"untdown(2))\r\n\t\t\t\t.done(function () {\r\n\t\t\t\t\t$.when(checkCall())\r\n\t\t\t\t\t\t.done(func" +
"tion () { \r\n\t\t\t\t\t\t\tif (attemptsLimit) ++attempts;\r\n\t\t\t\t\t\t\tintervalCheck();\r\n\t\t\t\t" +
"\t\t});\r\n\t\t\t\t})\r\n\t\t\t\t.fail(function () {\r\n\t\t\t\t\t//cancelCall();\r\n\t\t\t\t});\r\n\t\t}\r\n\r\n\t\t" +
"setTimeout(intervalCheck, 2000);\r\n\t}\r\n\r\n\t$phoneDialog.dialog(\"widget\").keydown(f" +
"unction(ev) {\r\n\t\tif ( ev.keyCode === $.ui.keyCode.ENTER || ev.keyCode === $.ui.k" +
"eyCode.NUMPAD_ENTER) {\r\n\t\t\tif (ViewModel.CallStation.Mode() == 1) {\r\n\t\t\t\t$($phon" +
"eDialogButtons.get(1)).click();\r\n\t\t\t\tev.preventDefault();\r\n\t\t\t\treturn false;\r\n\t\t" +
"\t}\r\n\t\t}\r\n\t});\r\n\r\n})(window, jQuery);\r\n\r\n");
...
"out(function (e) {\r\n\t\t\t$activeElement$ = null;\r\n\t\t})\r\n\r\n\t\t$(\"input[type=text]\")." +
"keydown(function (e) {\r\n\t\t\tif (e.keyCode == $.ui.keyCode.ENTER || e.keyCode == $" +
".ui.keyCode.NUMPAD_ENTER) {\r\n            if (this.className == \"ui-spinner-input" +
" hasDatepicker valid\" ||this.className == \"ui-spinner-input hasDatepicker\") {  e" +
".keyCode = $.ui.keyCode.ESCAPE; }\r\n\t\t\t\tif (!e.isPropagationStopped()){\r\n\t\t\t\t\t$(e" +
".currentTarget).focusNextInputField();}\r\n\t\t\t}\r\n\t\t});\r\n\r\n\t\t// Регистрация клиентс" +
"ких ошибок\r\n\t\twindow.onerror = postClientError;\r\n\t\t// Отмена справки по умолчани" +
"ю.\r\n\t\twindow.onhelp = function () { return false; }\r\n\t\t// Настройка установок Aj" +
"ax-запросов по умолчанию\r\n\t\tsetupJqueryAjax();\r\n\t\tsetupJqueryUiDialog();\r\n\t\tif (" +
"Env.scriptCapabilities.LoadGridScript) {\r\n\t\t\tsetupJqGrid();\r\n\t\t}\r\n\r\n\r\n\t}).keydow" +
"n(function (e) {\r\n\t\tif (e.keyCode == 27) { // Закрытие диалога по ESC\r\n\t\t\tvar qt" +
"ip = $(\'.qtip:visible\');\r\n\t\t\tif (qtip.length) {\r\n\t\t\t\tqtip.qtip(\'hide\');\r\n\t\t\t\te.s" +
"topImmediatePropagation();\r\n\t\t\t\te.preventDefault();\r\n\t\t\t\treturn false;\r\n\t\t\t}\r\n\t\t" +
"\t/*if ((window.opener && window.opener != window.self) || window.dialogWidth) {\r" +
"\n\t\t\tcloseDialog();\r\n\t\t\t}*/\r\n\t\t}\r\n\t\tif (e.keyCode == 112) { // Показ справки F1\r\n" +
"\t\t\tif ($.isFunction(window.showHelp)) {\r\n\t\t\t\tshowHelp();\r\n\t\t\t}\r\n\t\t\te.stopPropaga" +
"tion();\r\n\t\t\te.preventDefault();\r\n\t\t\treturn false;\r\n\t\t}\r\n\t});\r\n\r\n\tfunction postCl" +
"ientError(msg, url, line) {\r\n\t\tvar i;\r\n\t\tvar r = new RegExp(\"function[ ]{1,}([0-" +
"9a-z_]{1,})[^0-9a-z_]\",\"i\");\r\n\t\tvar obj=arguments.caller;\r\n\t\tvar s=\"\";\r\n\t\tvar m;" +
"\r\n\t\tvar fbody = (obj!=null)?obj.callee:\'\';\r\n\t\twhile (obj!=null) {\r\n\t\t\targs=\'\';\r\n" +
"\t\t\tfor (i=0;i<obj.length;i++)\r\n\t\t\t\targs+=(i>0?\',\':\'\')+obj[i];\r\n\r\n\t\t\tm = r.exec(o" +
"bj.callee);\r\n\t\t\ts = (((m instanceof Array)&&(m.length>1))?m[1]:\'?\')+\'(\'+args+\')\\" +
"n\\t\'+s\r\n\r\n\t\t\tobj=obj.caller;\r\n\t\t}\r\n\r\n        var appName = Env.AppName;\r\n\t\tvar e" +
"rrorMessage = [\"Приложение: \", appName, \"\\nСообщение: \", msg, \"\\nURL: \", url, \"\\" +
"nСтрока: \", line, \"\\n\\nСтек вызовов: \", s, \"\\n\\n\", fbody].join(\"\"); \r\n\r\n\t\t$.post" +
...
"msg: errorMessage\r\n\t\t});\r\n\t\t/*alertMessage(\r\n\t\t\t\tEnv.Localization.CheckCall_Erro" +
"r\r\n\t\t\t\t, errorMessage.replace(/\\n/ig, \"<br/>\") \r\n\t\t\t\t, Env.Localization.GUI_Butt" +
"on_OK \r\n\t\t);*/\r\n\t}\r\n\r\n\tfunction setupJqueryUiDialog() { }\r\n\r\n\tfunction setupJque" +
"ryAjax() {\r\n\t\t$.ajaxSetup({\r\n\t\t\tcache: false,\r\n\t\t\ttraditional: true,\r\n\t\t\tglobal:" +
" true,\r\n\t\t\tcontentType: \'application/x-www-form-urlencoded; charset=utf-8\'\r\n\t\t})" +
";\r\n\t\t$(document)\r\n\t\t\t.ajaxStart(function () {\r\n\t\t\t\t$(\"html\").addClass(\'busy\');\r\n" +
"\t\t\t\tViewModel.Processing(true);\r\n\t\t\t})\r\n\t\t\t.ajaxError(function (ev, xhr, setting" +
"s, thrownError) {\r\n\t\t\t\tif (thrownError == \"abort\") return;\r\n\t\t\t\tvar appName = En" +
"v.AppName;\r\n\t\t\t\tvar errorMessage = [\"Приложение: \", appName, \"\\nСообщение: \", th" +
"rownError, \"\\nURL: \", settings.url].join(\"\"); \r\n\t\t\t\t$.post(Env.URI_Default_Regis" +
"terClientError, {\r\n\t\t\t\t\tdetails: errorMessage\r\n\t\t\t\t});\r\n\t\t\t})\r\n\t\t\t.ajaxComplete(" +
"function () {\r\n\t\t\t\tViewModel.Processing(false);\r\n\t\t\t\t$(\"html\").removeClass(\'busy" +
"\');\r\n\t\t\t}); \r\n\t}\r\n\r\n\tfunction setupJqGrid() {\r\n\t\tjQuery.jgrid.del = $.extend(jQu" +
"ery.jgrid.del, {\r\n\t\t\tafterSubmit: function(xhr, postedData) {\r\n\t\t\t\t//alert (\'aft" +
"erSubmit\');\r\n\t\t\t\tvar ret = [true, \"\"];\r\n\t\t\t\tvar response = $.parseJSON(xhr.respo" +
"nseText);\r\n\t\t\t\tif (response.status == \"error\") {\r\n\t\t\t\t\tret[0] = false;\r\n\t\t\t\t\tret" +
"[1] = response.error;\r\n\t\t\t\t}\r\n\t\t\t\treturn ret;\r\n\t\t\t}\r\n\t\t});\r\n\t}\r\n\r\n\tvar __content" +
"PaneResizing = false;\r\n\tvar __contentPaneResizingReset = null;\r\n\r\n\tfunction resi" +
"zeContentPane() {\r\n\t\tvar $window = $(window);\r\n\t\t\t\r\n\t\tif (window.dialogWidth!=nu" +
"ll && window.dialogHeight!=null) {\r\n\t\t\tViewModel.Params.Width = $window.width();" +
"\r\n\t\t\tViewModel.Params.Height = $window.height();\r\n\t\t}\r\n\r\n\t\tif (__contentPaneResi" +
"zing) {\r\n\t\t\t__contentPaneResizing = false;\r\n\t\t\treturn;\r\n\t\t}\r\n\t\t__contentPaneResi" +
"zing = true;\r\n\r\n\t\tvar $header = $(\"#dialogHeader\");\r\n\t\tvar $content = $(\"#dialog" +
"ContentPane\");\r\n\t\tvar $footer = $(\"#dialogFooter\");\r\n\r\n\t\t$content.width($header." +
"outerWidth() - 6);\r\n\t\tvar height = $window.height() - $header.outerHeight() - $f" +
"ooter.outerHeight() - 15;\r\n\t\tif (height > 0) {\r\n\t\t\t$content.height(height);\r\n\t\t}" +
"\r\n\t\t$(\"#wndSize\").html(\"width: \" + $window.width() + \" | height: \" + $window.hei" +
"ght() + \" | header: \" + $header.outerHeight() + \" | footer: \" + $footer.outerHei" +
"ght() + \" | content: \" + ($content.outerHeight()));\r\n\t\tclearTimeout(__contentPan" +
"eResizingReset);\r\n\t\t__contentPaneResizingReset = setTimeout(function () {\r\n\t\t\t__" +
"contentPaneResizing = false;\r\n\t\t}, 50);\r\n\t}\r\n\r\n\tfunction saveSettings() {\r\n\t\t// " +
"готовим JSON-данные для отправки на сервер и маппинга на Dictionary<string, stri" +
"ng>\r\n\t\t// {\'settings[0].Key\': \"PersonBProject\", \'settings[0].Value\': \"1\", \'setti" +
"ngs[1].Key\': \"PersonAllBProject\", \'settings[1].Value\': \"0\", ...}\r\n\r\n\t\tvar settin" +
"gs = {}, i = 0;\r\n\t\tif (window.dialogWidth != null && window.dialogHeight != null" +
") {\r\n\t\t\tViewModel.Params.Width = window.dialogWidth.replace(\'px\', \'\');\r\n\t\t\tViewM" +
"odel.Params.Height = window.dialogHeight.replace(\'px\', \'\');\r\n\t\t}\r\n\r\n\t\tvar params" +
" = {};\r\n\t\tif (ViewModel.Params)\r\n\t\t\tparams = ko.mapping.toJS(ViewModel.Params);\r" +
"\n\t\tfor (var prop in params) {\r\n\t\t\tsettings[\'settings[\' + i + \'].Key\'] = prop;\r\n\t" +
"\t\tsettings[\'settings[\' + i + \'].Value\'] = (params[prop] == null) ? \"\" : params[p" +
"rop];\r\n\t\t\ti++;\r\n\t\t}\r\n\t\tvar data = $.extend({}, settings, { clid: ViewModel.CLID(" +
") });\r\n\r\n\t\t//alert(JSON.stringify(data));\r\n    \r\n\t\treturn $.ajax({\r\n\t\t\tasync: tr" +
"ue,\r\n\t\t\ttype: \'POST\',\r\n\t\t\turl: Env.URI_Default_SaveApplicationSettings,\r\n\t\t\ttrad" +
"itional: false,\r\n\t\t\tdata: data,\r\n\t\t\tbeforeSend: function() { },\r\n\t\t\tsuccess: fun" +
"ction( data ) {},\r\n\t\t\tcomplete: function() {}\r\n\t\t});\r\n    \r\n\t}\r\n\r\n\tfunction open" +
"PopupWindow(url, context, callback, windowName, width, height, replaceOptions) {" +
"\r\n\t\tvar uri = \"\"+url;\r\n\t\tvar cxt = $.extend({ type: \'GET\' }, context || {}, { ur" +
"l: url });\r\n\t\tif (cxt.type == \'POST\') {\r\n\t\t\t");
...
"\"DlgRez\");\r\n        \r\n\t\tif (dlgRez == 1) {\r\n\t\t\tresult = $.cookie(\"RetVal\", {raw:" +
" true});\r\n\t\t\tif (callback && $.isFunction(callback))\r\n\t\t\t\tcallback(result);\r\n\t\t}" +
"\r\n\r\n\t\t// очищаем данные в cookie\r\n\t\tSetDlgRez(0);\r\n\t\t$.removeCookie(\"RetVal\");\r\n" +
"\t}\r\n\r\n\tfunction SetDlgRez(dlgRez)\r\n\t{\r\n\t\tdocument.cookie=\'DlgRez=\'+ dlgRez +\';do" +
...
"(parentAction)\r\n\t{\r\n\t\tdocument.cookie=\'ParentAction=\'+ parentAction+\';domain=\'+c" +
"ookieDomain+\';path=\'+cookiePath;\r\n\t}\r\n\r\n\tfunction SetRetVal(retVal)\r\n\t{\r\n\t\tvar r" +
" = new RegExp(\"[^0-9a-z\\\\s\"+ String.fromCharCode(160) +\"]{1,}\",\"ig\"); \r\n\t\tretVal" +
" = retVal.replace(r,function($1) {return escape($1);});\r\n\t\tdocument.cookie=\'RetV" +
"al=\'+ retVal +\';domain=\'+cookieDomain+\';path=\'+cookiePath;\r\n\t}\r\n\r\n\tfunction Dial" +
"ogPageReturn(retVal,parentAction)\r\n\t{\r\n\t\tSetDlgRez(1);\r\n\t\tSetRetVal(retVal);\r\n\t\t" +
"SetParentAction(parentAction==null?0:parentAction);\r\n\r\n\t\tvar version = parseFloa" +
"t(navigator.appVersion.split(\'MSIE\')[1]);\r\n\t\tif (version<7)\r\n\t\t\twindow.opener=th" +
"is;\r\n\t\telse\r\n\t\t\twindow.open(\'\',\'_parent\',\'\');\r\n\r\n\t\twindow.close();\r\n\t}\r\n\r\n\tfunct" +
"ion searchGrid(gridID) {\r\n\t\tvar $grid = $(gridID);\r\n\t\tvar options = $grid.getGri" +
"dParam(\'searchDialogOptions\');\r\n\t\toptions.left = 50;\r\n\t\toptions.top = 50;\r\n\t\topt" +
