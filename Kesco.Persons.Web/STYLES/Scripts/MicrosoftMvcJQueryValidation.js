...
function __MVC_ApplyValidator_Min(object, value) {
    object["min"] = value;
}

function __MVC_ApplyValidator_Max(object, value) {
    object["max"] = value;
}
...
function __MVC_CreateRulesForField(validationField) {
    ...
    for (var i = 0; i < validationRules.length; i++) {
        ...
        switch (thisRule.ValidationType) {
            case "min":
                __MVC_ApplyValidator_Min(rulesObj, thisRule.ValidationParameters["min"]);
                break;

            case "max":
                __MVC_ApplyValidator_Max(rulesObj, thisRule.ValidationParameters["max"]);
                break;
