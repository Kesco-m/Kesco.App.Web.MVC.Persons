...
$.widget( "ui.spinner", {
	...
	_setOptions: modifier(function( options ) {
		if ($.isFunction(this._super)) this._super( options );
		else $.Widget.prototype._setOptions.call(this, options);
	...
	_format: function( value ) {
		...
		if (window.Globalize && this.options.numberFormat) {
			var format = this.options.numberFormat && this.options.numberFormat == "n" ? "n" : "n10";
			var culture = Globalize.culture(this.options.culture);
			var separator = culture.numberFormat["."];
			separator = (separator == '.') ? ("\\"+separator) : separator;
			var rex = new RegExp("("+separator+"\\d*[1-9])0+$");
			val = Globalize.format( value, 
				(this.options.numberFormat && (this.options.numberFormat == "n" || this.options.numberFormat == "n0")) ? "n10" : this.options.numberFormat, 
