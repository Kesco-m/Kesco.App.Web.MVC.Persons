...
;(function($) {
	...
	$.fmatter.util = {
		...
		NumberFormat : function(nData,opts) {
			var _format = "n"+(opts.decimalPlaces?opts.decimalPlaces:"0");
			return isNaN(nData) || Globalize.format(nData, _format, opts.culture);
	...
	$.fn.fmatter.integer = function(cellval, opts) {
		...
		return Globalize.format(cellval, "n0", op.culture);
	};
	$.fn.fmatter.number = function (cellval, opts) {
		...
		return Globalize.format(cellval, "n"+(op.decimalPlaces?op.decimalPlaces:""), op.culture);
	};
	$.fn.fmatter.currency = function (cellval, opts) {
		...
		return Globalize.format(cellval, "c", op.culture);
	};
	...
	$.fn.fmatter.actions = function(cellval,opts, rwd) {
		...
		if(op.editformbutton){
			...
			str =str+ "<div title='"+$.jgrid.nav.edittitle+"' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' "+ocl+"><a href='javascript: void(0);'><span class='ui-icon ui-icon-pencil'></span></a></div>";
		...
		if(op.delbutton) {
			...
			str = str+"<div title='"+$.jgrid.nav.deltitle+"' style='float:left;margin-left:5px;' class='ui-pg-div ui-inline-del' "+ocl+"><a href='javascript: void(0)'><span class='ui-icon ui-icon-trash'></span></a></div>";
		}
		...
		str = str+"<div title='"+$.jgrid.edit.bSubmit+"' style='float:left;display:none' class='ui-pg-div ui-inline-save' "+ocl+"><a href='javascript: void(0)'><span class='ui-icon ui-icon-disk'></span></a></div>";
		...
		str = str+"<div title='"+$.jgrid.edit.bCancel+"' style='float:left;display:none;margin-left:5px;' class='ui-pg-div ui-inline-cancel' "+ocl+"><a href='javascript: void(0)'><span class='ui-icon ui-icon-cancel'></span></a></div>";
			...
			for(var i = 0; i<clone; i++) {
				...
				if($t.p._nvtd) {
					if(twd > $t.p._nvtd[0] ) {
						...
						$(pgid+"_"+o.position,pgid).width("auto");
						$t.p._nvtd[0] = twd;
					}
					$t.p._nvtd[1] = twd;
				}
		...
		return this.each(function() {
			...
			if (findnav) {
				...
				if(p.buttonicon.toString().toUpperCase() == "NONE") {
					...
					$(tbd).addClass('ui-pg-button ui-corner-all').append("<div class='ui-pg-div'><a href='javascript: void(0);'><span class='ui-icon "+p.buttonicon+"'></span>"+p.caption+"</a></div>");
				}
			...
			*/
			...
			if (findnav) {
				...
				*/
				...
				$("<a href='javascript: void(0);'>"+(p.caption || "&nbsp;")+"</a>")
					.appendTo(tbd)
					.button({
						text: !!p.caption,
						icons: { primary: p.buttonicon },
						label: p.title || null
					})
					.click(function(e){
						if (!$(this).hasClass('ui-state-disabled')) {
					...
					complete: function(res,stat){
						...
						if (stat === "success"){
							...
							if( $.isFunction(o.successfunc)) { 
								sucret = o.successfunc.call($t, res, "save");
								if($.isArray(sucret)) {
							...
							if (ret===true) {
								...
								if($.isFunction(o.errorfunc) ) {
									o.errorfunc.call($t, rowid, res, stat, "save");
								}
