...
namespace Kesco.Persons.Controls.ComponentModel
{
	...
	/// </summary>
	public class PersonSimpleSelectAttribute : KescoSelectAttribute
	{

		/// <summary>
		/// Создаёт новый экземпляр <see cref="PersonSelectAttribute"/> класса.
		/// </summary>
		public PersonSimpleSelectAttribute()
			: base("PersonSimpleSelect")
		{
			EntityAccessorType = typeof(PersonSimpleSelectAccessor);
			KeyField = "ID";
			DisplayField = "Nickname";
			AutocompleteController = "PersonSimpleSelect";
			AutocompleteAction = "SearchEx";
			AutocompleteLimit = 8;
			SelectControllerType = typeof(PersonSimpleSelectController);
