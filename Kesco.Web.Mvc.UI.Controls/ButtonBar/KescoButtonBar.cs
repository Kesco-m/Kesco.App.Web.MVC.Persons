...
{
	public class KescoButtonBar : ControlBase
	{
		...
		public KescoButtonBar(ViewContext viewContext)
			: base(viewContext)
		{
			Buttons = new List<KescoButtonBarItem>();
		}
		...
		/// Список кнопок
		/// </value>
		public List<KescoButtonBarItem> Buttons { get; set; }
		...
		{
			KescoButtonBarHtmlBuilder builder = new KescoButtonBarHtmlBuilder(this);
